...
from .collate import collate_video_pose
from .dataset import VideoPoseContextDataset
from .index_builder import build_video_pose_index, load_index
...
def build_datasets(cfg: dict[str, Any]):
    ...
    train_ds = VideoPoseContextDataset(train_rows, cfg['data'], split='train', seed=int(cfg['project']['seed']))
    val_ds = VideoPoseContextDataset(val_rows, cfg['data'], split='val', seed=int(cfg['project']['seed']))
